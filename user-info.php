...
<?php $page = "Users"; include 'manu.php';?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-user fa-lg"></i> ข้อมูลสมาชิก</h1>
            <p>หน้าจอสำหรับแสดงข้อมูลสมาชิก</p>
          </div>
        </div>
                ...
                <div class="row mb-20">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="inputName" name="username" type="text" placeholder="A-Z, 0-9 ความยาว 4-32 ตัวอักษร" data-minlength="4" maxlength="32" data-error="ต้องมีความยาวอย่างน้อย 4 ตัวอักษร" onkeypress="check_space();" required  value="<?php echo $mem_user ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="animated-radio-button">
                            <div class="radio">
                                <label><input type="radio" name="usertype" value="0" <?php if($mem_usertype=="0") echo 'checked' ?>><span class="label-text">แอดมิน</span></label>
                                <label><input type="radio" name="usertype" value="1" <?php if($mem_usertype=="1") echo 'checked' ?>><span class="label-text">อาจารย์</span></label>
                                <label><input type="radio" name="usertype" value="2" <?php if($mem_usertype=="2") echo 'checked' ?>><span class="label-text">นักศึกษา</span></label>
                            </div>
                        </div>
                    </div>
